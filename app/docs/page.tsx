      ...
      >
        ...
        >
          <SectionHeader
            ...
            subtitle="Two yield layers available on every YO Protocol vault."
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-4xl mb-8">
            ...
            <div className="bg-bg-card border border-border-default rounded-xl p-5 shadow-card">
              ...
              <p className="font-inter text-text-secondary text-sm leading-relaxed">
                The primary yield generated by the YO Protocol vault strategy — sourced from lending,
                staking, or liquidity provision depending on the vault. This yield is automatically
                compounded into the vault share price continuously, so your position grows passively
                with no manual action required. Visible in real-time on the Dashboard.
              </p>
            </div>
            ...
            <div className="bg-bg-card border border-border-default rounded-xl p-5 shadow-card">
              ...
              <p className="font-inter text-text-secondary text-sm leading-relaxed">
                ...
                {' '}to YO vault depositors. Not automatic — must be claimed manually from the
                Rewards page whenever there is a claimable balance. Each claim is an on-chain
          ...
          <div className="bg-bg-card border border-border-default rounded-xl shadow-card max-w-2xl overflow-hidden">
            <div className="grid grid-cols-3 gap-0 border-b border-border-subtle">
              <div className="px-5 py-3">
                <p className="font-space-grotesk text-text-tertiary text-xs font-semibold uppercase tracking-wider">Aspect</p>
              </div>
            ...
            {[
              ['Source', 'YO Protocol strategy', 'Merkl Protocol (incentive)'],
              ['Process', 'Auto-compounded', 'Manual claim required'],
              ['View in', 'Dashboard → active positions', 'Rewards page'],
              ['Frequency', 'Continuous (real-time)', 'Periodic per Merkl epoch'],
              ['On-chain tx', 'Not required', 'Required to claim'],
